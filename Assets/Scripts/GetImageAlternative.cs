...
public class GetImageAlternative : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        _cameraImageTexture = new Texture2D(_targetRenderTexture.width, _targetRenderTexture.height,
            TextureFormat.RGBA32, false);
        Graphics.CopyTexture(_targetRenderTexture, _cameraImageTexture);

        var result = _reader.Decode(_cameraImageTexture.GetPixels32(), _cameraImageTexture.width,
